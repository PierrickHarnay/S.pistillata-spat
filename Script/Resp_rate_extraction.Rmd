---
title: "Respiration rate calculations"
...
## Import data
```{r, warning = FALSE}
path.p <- "Ranalysis/data/Resp" #the location of all your respirometry files 
...
sample.info <- read_csv(file = "Ranalysis/data/Resp/PR_sample_metadata.csv")

# Load PI curve run metadata (i.e., light levels and interval times for each run)
run.info <- read_csv(file = "Ranalysis/data/Resp/PR_run_metadata.csv")
