...
#merge the data with the polyp_number 
...
merged_SEM$Polyp_ID <- as.numeric(as.character(merged_SEM$Polyp_number))

# Create individual plots
Mean_Primary <- ggplot(merged_SEM, aes(x = Polyp_number, y = Mean_Primary_septa)) +
  geom_point(color = "steelblue", size = 2) +
  geom_line(color = "steelblue") +
  theme_minimal() +
  labs(title = "Mean Primary Septa across Polyps", x = "Polyp ID", y = "Mean Primary Septa")
``` 
