...
starttimes<-read.csv("Ranalysis/data/Resp/starttimes.csv") #read in file of starting R and P phase times
...
Merge Resp values with sample info for testing and manipulation.  
...
ggplot(data = oxygen.bio, aes(x = log10(as.numeric(Polyp.Number)), y = log10(R.nmol.mm2.min))) +
  stat_poly_line() +
